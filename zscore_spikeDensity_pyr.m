function zscore_spikeDensity_pyr(smoothing_sigma,align_to_lfp)
...
if smoothing_sigma==0.0125 % default
    save('zscored_sd_pyr','zscored_sd');
else
    save(['zscored_sd_pyr_smoothing_' num2str(smoothing_sigma*10000,2)],'zscored_sd');
end
