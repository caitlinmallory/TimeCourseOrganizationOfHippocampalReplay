...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
restrict_to_excitatory_cells = 0;
restrict_to_inhibitory_cells = 1;
...
elseif restrict_to_inhibitory_cells == 1
    meets_excitatory_inhibitory_criterion = ~[clusters.Excitatory]';    
else
...
if length(ind_cluster)==0
    spikeDensity = [timeEdges nan(size(timeEdges))];
else
...
save('spikeDensity_inhibitory.mat','spikeDensity')
