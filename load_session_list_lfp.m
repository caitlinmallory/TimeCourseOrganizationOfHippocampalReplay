    ...
    elseif rat == 2 %Bo
        ...
        dayFiles = {'20210505','20210507','20210508','20210509/kilosort_clustered','20210511/kilosort_clustered','20210512/kilosort_clustered','20210513/kilosort_clustered','20210517/kilosort_clustered'};
    elseif rat == 3 % MEC1
        directory = '/home/caitlin/Data/Processed_Data/MEC1';
        dayFiles = {'20200926/kilosort_clustered','20200927/hand_clustered2','20201030','20201103','20201104'};
    elseif rat ==4
        directory = '/home/caitlin/Data/Processed_Data/Bolt/linear_track';
     dayFiles = {'20220714/msort_clustered','20220715/msort_clustered','20220718_1/msort_clustered','20220719_1_opto/msort_clustered_full','20220720/msort_clustered','20220722/msort_clustered_full','20220729/msort_clustered'};
        %dayFiles = {'20220718_2}; is noisy
    elseif rat == 5
    ...
    % 022323_3 has some noise
    
    elseif rat == 7 % Janni
        directory = '/home/caitlin/Data/Processed_Data/Janni';
        dayFiles = ...
            {'20100408_run1','20100410_run1','20100410_run2','20100410_run3','20100413_run1','20100413_run2'};
        % '20100412_run1 is very strange- lots of big long deflections
        % '20100413_run1 is very strange- lots of big long deflections
        % '20100413_run2 is very strange- lots of big long deflections
%     elseif rat == 8 % Harpy
%         directory = '/home/caitlin/Data/Processed_Data/Harpy';
%         dayFiles = ...
%             {'20100114_run1','20100115_run1','20100115_run2'};
%         %20100114_run1 noisy
% all of Harpy data is super noisy
    elseif rat == 9 % Imp
