...
t_events.('sde') = sub_events(sub_events.good_candidate_event==1,:);
...
sub_events = load_replays_from_individual_session(events,use_duration_og,coverage_thr,...
    weighted_r_thr,posterior_diff_thr,sde_thr,ripple_thr,min_time_into_stopping_period,max_time_into_stopping_period);
t_events.('ripples') = sub_events(sub_events.good_candidate_event==1,:);
...
t_events.('past_map_event_spike') = sub_events(sub_events.good_candidate_event==1 & sub_events.past_map_replay==1,:);
t_events.('future_map_event_spike') = sub_events(sub_events.good_candidate_event==1 & sub_events.future_map_replay==1,:);
...
%% past or future representations, using Ripples as candidate events:
% Start with SDEs. Then look for representations of the past or future map
events = 'ripple_filtered';
sde_thr = -inf;
ripple_thr = 3;
...
t_events.('past_map_event_ripple') = sub_events(sub_events.good_candidate_event==1 & sub_events.past_map_replay==1,:);
t_events.('future_map_event_ripple') = sub_events(sub_events.good_candidate_event==1 & sub_events.future_map_replay==1,:);
...
% sub_events = load_replays_from_individual_session(events,use_duration_og,coverage_thr,...
%     weighted_r_thr,posterior_diff_thr,sde_thr,ripple_thr,min_time_into_stopping_period,max_time_into_stopping_period);
% t_events.('reverse_replays_filtered') = sub_events(sub_events.reverse_replay==1,:);
% t_events.('forward_replays_filtered') = sub_events(sub_events.forward_replay==1,:);
% t_events.('congruent_replays_filtered') = sub_events(sub_events.congruent_replay==1,:);
% t_events.('incongruent_replays_filtered') = sub_events(sub_events.incongruent_replay==1,:);
% t_events.('forward_congruent_replays_filtered') = sub_events(sub_events.forward_congruent_replay==1,:);
% t_events.('forward_incongruent_replays_filtered') = sub_events(sub_events.forward_incongruent_replay==1,:);
% t_events.('reverse_congruent_replays_filtered') = sub_events(sub_events.reverse_congruent_replay==1,:);
% t_events.('reverse_incongruent_replays_filtered') = sub_events(sub_events.reverse_incongruent_replay==1,:);

%% past or future representations, using John's filtering as candidate events
% Start with SDEs. Then look for representations of the past or future map
% events = 'filtered';
% sde_thr = 3;
% ripple_thr = -inf;
...
%     weighted_r_thr,posterior_diff_thr,sde_thr,ripple_thr,min_time_into_stopping_period,max_time_into_stopping_period);
% 
% t_events.('past_map_event_filtered') = sub_events(sub_events.good_candidate_event==1 & sub_events.past_map_replay==1,:);
% t_events.('future_map_event_filtered') = sub_events(sub_events.good_candidate_event==1 & sub_events.future_map_replay==1,:);
...
save('replay_by_stopping_period','t2','first_event_time_table','last_event_time_table','event_hists');
